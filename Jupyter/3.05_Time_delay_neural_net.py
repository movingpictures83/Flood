...
from ml_flood.python.misc.plot import plot_multif_prediction

# load data
ds = xr.open_dataset('/lclhome/mwei005/Flood/Jupyter/ml_flood/data/features_xy.nc')
...
from ml_flood.python.misc.utils_floodmodel import reshape_scalar_predictand
...
from ml_flood.python.misc.utils_floodmodel import multi_forecast_case_study_tdnn
