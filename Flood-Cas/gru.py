...
n_hours = 72
n_features = 16  # 1 rainfall + 2FG_S25A + 2FG_S25B + 2FG_S26 + 8ws + pump_S26
K = 12
...
# LSTM Model
model = Sequential()
model.add(GRU(65, input_shape=(train_X.shape[1], train_X.shape[2])))
...
# Test: 'WS_S1', 'WS_S4', 'TWS_S25A', 'TWS_S25B', 'TWS_S26', 'HWS_S25A', 'HWS_S25B', 'HWS_S26'
plt.rcParams["figure.figsize"] = (8, 6)
